                ...
                <section class="rounded-[2rem] border border-blue-100 bg-white p-8 shadow-xl shadow-blue-50">
                    <form id="edit-user-form" class="grid gap-5">
                        ...
                        <div>
                            ...
                            <input id="password-new" type="password" placeholder="Actualiza tu contraseña" class="w-full rounded-2xl border border-blue-100 bg-blue-50 px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-blue-400 focus:outline-none" />
                        </div>
                        <div class="flex flex-col gap-3 pt-2 sm:flex-row">
                            ...
                            <button type="button" id="delete-user" class="cursor-pointer inline-flex items-center justify-center rounded-2xl border border-red-200 bg-white px-5 py-3 text-sm font-bold text-red-700 hover:bg-red-100">Eliminar mi cuenta</button>
                        </div>
                    </form>
                </section>
            </section>
